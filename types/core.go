...
type Core struct {
	...
	UseCdn        NullBool           `gorm:"column:use_cdn;default:0" json:"using_cdn,omitempty"`
	UpdateNotify  NullBool           `gorm:"column:update_notify;default:1" json:"update_notify,omitempty"`
